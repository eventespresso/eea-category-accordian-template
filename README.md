EE4 Category Accordian Template
=========

[![Latest Release](https://img.shields.io/github/tag/eventespresso/eea-category-accordian-template.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/eea-category-accordian-template/releases)
...
This is a template for Event Espresso 4 that displays events in a category accordian style.
...
> Note, this add-on is not officially released.  **Use at your own risk.**

| **Some Links**|     |
|---- | --- |
**Support License** | Support for this add-on is not provided through this repository.  For support you can purchase a [Premium Support License](https://eventespresso.com/pricing?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license).
